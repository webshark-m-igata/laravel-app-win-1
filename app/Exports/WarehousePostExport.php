...
class WarehousePostExport
{
    /**
     * Export warehouse posts to CSV
     *
     * @param array $options
    ...
    {
        $warehousePosts = WarehousePost::all();

        $csvExporter = new Export();

        // ヘッダーのマッピング
        $csvExporter->build($warehousePosts, [
            'id' => 'ID',
            'warehouse_id' => '倉庫ID',
            'title' => 'タイトル',
            'content' => '内容',
        ...
        // ファイル名の設定
        $filename = '倉庫投稿_' . date('Y-m-d_His') . '.csv';
