...
export default function WarehouseCommentList({ comments, warehousePostId, auth }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('warehouse.comments.store', warehousePostId), {
            onSuccess: () => {
                reset();
    ...
    const handleDelete = (commentId) => {
        if (confirm('このコメントを削除してもよろしいですか？')) {
            router.delete(route('warehouse.comments.destroy', commentId));
        }
    };
