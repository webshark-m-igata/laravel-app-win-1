                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-lg font-medium">あなたの投稿一覧</h3>
                                <Link
                            ...
                            {posts && posts.length > 0 ? (
                                ...
                                >
                                    ...
                                    <Column
                                        ...
                                        sortable
                                        filter
                                        filterPlaceholder="ショップで検索"
                                        style={{ width: '15%' }}
                                        body={(rowData) => rowData.shop ? rowData.shop.name : 'Unknown'}
                                    />
                                    <Column
                                        field="created_at"
                                        header="作成日時"
                                    ...
                                    <Column
                                        ...
                                        body={(rowData) => (
                                            <div className="flex gap-2">
                                                <Link href={route('post.show', rowData.id)}>
                                                    <Button icon="pi pi-eye" className="p-button-sm p-button-info" />
                                                </Link>
                                                <Link href={route('post.edit', rowData.id)}>
